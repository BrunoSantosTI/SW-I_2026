...
<body id="sobre">
    <section id="sobre-section">
        ...
        <div class="sobre-content">
            <h1 class="titulo">O que é o Duolingo?</h1>
            <p>O Duolingo é uma plataforma de aprendizado de idiomas criada para tornar a educação gratuita e acessível para todos. Fundado por <b>Luis von Ahn</b>, o aplicativo utiliza técnicas de gamificação para ensinar idiomas de maneira leve e eficaz.</p>
            <p>Com milhões de usuários ao redor do mundo, o Duolingo oferece cursos em diversos idiomas, incluindo inglês, espanhol, francês, alemão e muitos outros.</p>
        </div>
    </section>
